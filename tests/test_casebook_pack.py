"""Regression checks for the helix-rel-chaos-yard casebook."""
...
from casebook.harness import assert_expected, helix_rel_chaos_yard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(helix_rel_chaos_yard_summary(), assert_expected())
